...
createServer({
    ...
    seeds(server) {
        server.create("movie", {
            ...
            imageUrl: "https://i.ebayimg.com/images/g/KjQAAOSwOTdl0jOb/s-l1600.jpg",
            type: "comedy",
            price: 30
        });
        ...
        server.create("movie", {
            ...
            imageUrl: "https://tse4.mm.bing.net/th/id/OIP.erDwKbNABXG1u2sRxgMzxgHaLG?rs=1&pid=ImgDetMain&o=7&rm=3",
            type: "thriller",
            price: 25
        });
